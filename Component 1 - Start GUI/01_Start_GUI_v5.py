"""01_Start_GUI_v5
Trialling Checkbutton for number of questions and assist
"""
...
class Start:
    def __init__(self):
        ...
        quest_check_button1 = IntVar()
        quest_check_button2 = IntVar()

        assist_check_button1 = IntVar()
        assist_check_button2 = IntVar()
        assist_check_button3 = IntVar()

        question_number_1 = Checkbutton(self.sub_frame, text='15',
                                        variable=quest_check_button1,
                                        onvalue=15, offvalue=0,
                                        font='Arial 16 bold', command=lambda:
                                                    self.print_txt(15, False))
        question_number_2 = Checkbutton(self.sub_frame, text='20',
                                        variable=quest_check_button2,
        ...
        assist_1 = Checkbutton(self.sub_frame, text='1',
                               variable=assist_check_button1,
                               onvalue=20, offvalue=0, font='Arial 16 bold',
                               command=lambda: self.print_txt(False, 1))
        assist_2 = Checkbutton(self.sub_frame, text='2',
                               variable=assist_check_button2,
                               onvalue=20, offvalue=0, font='Arial 16 bold',
                               command=lambda: self.print_txt(False, 2))
        assist_3 = Checkbutton(self.sub_frame, text='3',
                               variable=assist_check_button3,
                               onvalue=20, offvalue=0, font='Arial 16 bold',
