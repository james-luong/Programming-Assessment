...
class Quiz:
    ...
    def next_quest(self, quest_no):
        ...
        quest_ans_list[quest_no][1] = [i for i in quest_ans_list[
            quest_no][1]]
        shuffle(quest_ans_list[quest_no][1])

        print(quest_ans_list)

        self.quest_label.config(text=quest_ans_list[quest_no][0])

        self.answer_1.config(state=NORMAL,
                             text=quest_ans_list[quest_no][1][0])
        self.answer_2.config(state=NORMAL,
                             text=quest_ans_list[quest_no][1][1])
        self.answer_3.config(state=NORMAL,
                             text=quest_ans_list[quest_no][1][2])
        self.answer_4.config(state=NORMAL,
                             text=quest_ans_list[quest_no][1][3])
