"""
05_Main_quiz_v2
Explain more detail in Instruction GUI
Increase number of assistance from 1, 2, 3 to 3, 4, 5
Add Help GUI (02_Help_GUI_v4)
"""
...
class Quiz:
    def __init__(self):
        ...
        # assist button
        self.assist_button = Button(self.assist_frame, text=f'Assistance '
                                                            f'(50/50):'
                                                         f' {self.num_assist}',
                                    command=self.assist)
