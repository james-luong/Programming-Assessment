"""
03_Assistance_v3
Add the number of assists user can use (max = 3)
Disable permanently after using all number of assists
i.e. next quest button will not restore assist button anymore
"""
